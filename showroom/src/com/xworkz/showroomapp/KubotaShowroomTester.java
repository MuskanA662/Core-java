...
import com.xworkz.showroomapp.constant.KubotaShowroom;
import com.xworkz.showroomapp.constant.Manager;

public class KubotaShowroomTester {
public static void main(String args[]) {
		...
		KubotaShowroom bj = new KubotaShowroom();
